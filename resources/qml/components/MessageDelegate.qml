    ...
    Component {
        ...
        MessageBubble {
            ...
            content: Label {
                ...
                text: html
                color: appWindow.isOnBubble(model.isOutgoing) ? "white" : appWindow.bubbleTextColor
            ...
            content: Column {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        height: 60
                        radius: 30
                        color: appWindow.isOnBubble(model.isOutgoing) ? "#40ffffff" : appWindow.bubbleAccentColor
                    ...
                    Column {
                        ...
                        Label {
                            ...
                            color: appWindow.isOnBubble(model.isOutgoing) ? "white" : appWindow.bubbleSecondaryColor
                            opacity: appWindow.isOnBubble(model.isOutgoing) ? 0.75 : 1.0
                            font.pixelSize: 18
                            font.weight: Font.Light
                        }
                    }
