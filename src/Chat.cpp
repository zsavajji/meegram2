...
File *Chat::bigPhoto() const noexcept
{
...
const std::shared_ptr<File> &Chat::bigPhotoFile() const noexcept
{
    return m_bigFile;
}

void Chat::adoptBigPhotoFile(std::shared_ptr<File> file) noexcept
{
